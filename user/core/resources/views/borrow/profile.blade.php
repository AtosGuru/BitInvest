...
<div class="right-content">
                ...
                <div class="register-content" >
                    <form method="post" class="margin-bottom-0"action="{{ route('borrow.update_user1') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <div class="row row-space-10">
                         ...
                         <div class="row row-space-10">
                            ...
                            <button type="submit" style=" background-color: #008a8a; color: white;"  class="btn green">Update</button>
