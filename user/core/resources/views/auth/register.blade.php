...
<section id="login">
    <span class="signup bottom"><center><a href="http://18.188.45.2"><i class="fa fa-arrow-left
"> </i> &nbsp;Back</a></center></span>
        <div class="container">
...
@endif
                   ...
                   <div class="text-center">
                    ...
                    <span class="reset bottom"><a href="{{ route('login') }}">LOGIN NOW</a></span>
                  </div>
                </div>
                </div>
                </div>
