...
Route::get('/404', function () {
	$i = DB::table('settings')->where('keyname','site_url')->first();
    return redirect($i->value);
})->name('404');
...
Route::post('/update_userinfo','borrowController@update_userinfo')->name('borrow.update_user');
Route::post('/kyc_update','borrowController@kyc_update1')->name('borrow.kyc_update1');
Route::post('/update_userinfo1','borrowController@update_userinfo1')->name('borrow.update_user1');
Route::post('/kyc_update1','borrowController@kyc_update')->name('borrow.kyc_update');
Route::post('/apply_borrow','borrowController@apply_borrow')->name('borrow.apply');
Route::get('/profile','borrowController@profile')->name('borrow.profile');
Route::get('/kyc','borrowController@kyc')->name('borrow.kyc');
Route::get('/myborrowings','borrowController@my_borrow')->name('myborrowings');
Route::get('/my_transactions','borrowController@transactions')->name('my_transactions');
Route::get('/my_payments','borrowController@my_payments')->name('my_payments');

Route::post('/wallet_edit','borrowController@wallet_edit')->name('edit.wallet');

Route::get('/payments_based_search/{id}','borrowController@payment_by_id')->name('payments.id');

Route::post('/pay_amount','borrowController@pay')->name('pay.amount');

Route::post('/deposit_amount','borrowController@deposit_amount')->name('user.deposit');

Route::get('/getajaxMonth','borrowController@getajaxMonth');
...
Route::get('/getTrxStatus','borrowController@getTrxStatus');
 ...
 Route::get('/pay_status/{id}','borrowController@pay_status')->name('pay_status');
 Route::get('/pay_status_monthly/{id}','borrowController@pay_status_monthly')->name('pay_status_monthly');


 Route::get('/get_status/{id}','borrowController@get_status');
