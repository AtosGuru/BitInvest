...
Route::get('/404', function () {
    return redirect('http://18.188.45.2/admin');
})->name('404');
...
Route::post('/interface/update', 'InterfaceController@update')->name('interface.update');
  ...
  Route::get('/user_delete/{user}', 'UserlogController@delete')->name('user.delete');

  Route::get('/user_lock/{user}', 'UserlogController@lock')->name('user.lock');
  Route::get('/user_unlock/{user}', 'UserlogController@unlock')->name('user.unlock');
...
Route::get('/deposits/requestsAjax', 'DepositController@requestsAjax');
...
// borrow
  ...
  Route::get('/borrow_user', 'borrowController@users')->name('borrow.users');
Route::get('/borrow_user_translog', 'borrowController@borrow_user_translog')->name('borrow.transactions');
Route::get('/user_banned_borrow', 'UserlogController@banusers_borrow')->name('borrow.ban');
Route::get('/borrow_package', 'borrowController@show_package')->name('borrow.package');
Route::post('/borrow_update', 'borrowController@update_package')->name('update.package');
Route::get('/borrow_requests', 'borrowController@requests')->name('borrow.requests');
Route::get('/borrow/approve/{id}', 'borrowController@approve')->name('borrow.approve');
Route::get('/borrow/verify/{id}', 'borrowController@verify')->name('borrow.verify');
Route::get('/borrow/delete/{id}', 'borrowController@delete')->name('borrow.delete');
Route::get('/borrow/ongoing', 'borrowController@ongoing')->name('borrow.ongoing');
Route::get('/borrow/payments', 'borrowController@my_payments')->name('borrow.payments');
Route::get('/borrow/pay_approve/{id}', 'borrowController@approve_payment')->name('borrow.pay_approve');
Route::get('/borrow/pay_delete/{id}', 'borrowController@delete_payment')->name('borrow.pay_delete');

Route::get('/borrow/single_user/{id}', 'borrowController@single_user')->name('borrow.single_user');


Route::get('/admin_delete/{id}', 'AdminAuth\RegisterController@delete')->name('admin.delete');

  Route::get('/admin_lock/{id}', 'AdminAuth\RegisterController@lock')->name('admin.lock');
  
  Route::get('/admin_unlock/{id}', 'AdminAuth\RegisterController@unlock')->name('admin.unlock');


  Route::get('/delete_notify/{id}','NotifyController@delete_notify');
 Route::get('/getNotification','NotifyController@notification');

 Route::get('/getTrxStatus','borrowController@getTrxStatus');
  ...
  Route::get('/password_reset', 'AdminAuth\ForgotPasswordController@showLinkRequestForm')->name('admin.password_reset');
