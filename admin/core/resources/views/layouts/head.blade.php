...
<head>
    ...
    <link href="{{ asset('assets/user/plugins/jquery-jvectormap/jquery-jvectormap.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/user/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/user/plugins/gritter/css/jquery.gritter.css') }}" rel="stylesheet" />
    ...
    <script src="{{ asset('assets/user/js/jquery.min.js') }}"></script>
     ...
     <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css">
        ...
        <link rel="stylesheet" type="text/css" href="https://seantheme.com/color-admin-v4.1/admin/assets/css/default/style.min.css">
</head>
