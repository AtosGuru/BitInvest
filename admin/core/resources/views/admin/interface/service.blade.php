       ...
       <div class="row" >
        ...
        <div class="col-md-3">
          <div class="panel panel-primary" >
            <div class="panel-heading"  style="background-color: #1a2229" >Service {{$service->id}}</div>
                ...
                <form role="form" method="POST" action="{{route('service.update',$service->id)}}" enctype="multipart/form-data">
                 ...
                 {{method_field('put')}}
                  <div class="form-group">
                      <label for="image">Service <a href="http://fontawesome.io/icons/" target="_blank">Font Awesome</a> Icon</label>
