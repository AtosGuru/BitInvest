...
<div class="row">
  ...
  <table class="table">
        <tr>
          ...
          <th style="color: white">TRX ID</th>
          <th style="color: white">Details</th>
        </tr>
        @foreach($trans as $log)
        <tr>
          <td><span class="btn btn-my btn-{{$log->type == '0' ? 'warning' : 'success'}}">
...
<div class="row">
  <input type="hidden" id="sent_count" value="{{$sent_count}}">
   <input type="hidden" id="sent_amount" value="{{$sent_amount}}">
    <input type="hidden" id="rec_count" value="{{$rec_count}}">
     <input type="hidden" id="rec_amount" value="{{$rec_amount}}">
    <div class="col-md-12">
<div class="row">
