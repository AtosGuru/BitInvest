...
<link href="{{asset('assets/assets/css/style-responsive.min.css')}}" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="{{asset('assets/admin/pages/css/default.css')}}">
...
<script src="https://seantheme.com/color-admin-v4.1/admin/assets/plugins/pace/pace.min.js"></script>
</head>
