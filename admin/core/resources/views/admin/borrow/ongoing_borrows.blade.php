...
<div class="row">
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase">User Ongoing Borrows</span> 
        </div> 
        ...
        <p>1. Track all the list of on going borrowings from this page.</p>
        <p>2. By clicking on the borrower's name you can check the borrower's profile.</p>
  ...
  <table class="table">
        ...
        <td>{{$log->amount_in_btc}} BTC</td>
        <td>{{$log->repay}} BTC</td>
        <td>{{$log->monthly_payments}} BTC</td>
        <td>{{$log->installment}} Months</td>
        <td>
                          <a  class="btn btn-outline btn-circle btn-sm green">
                             <i class="fa fa-check"></i> Ongoing </a>
                             </td>
