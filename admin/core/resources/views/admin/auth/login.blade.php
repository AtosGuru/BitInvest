...
<form class="login-form" role="form" method="POST" action="{{ url('admin/login') }}">
  ...
  <div class="form-group">
    ...
    <input id="username" type="text" class="form-control form-control-solid placeholder-no-fix" placeholder="Username" name="username" value="admin" autofocus>
  </div>
  ...
  <div class="form-group" >
    ...
    <input id="password" type="password" class="form-control form-control-solid placeholder-no-fix" name="password" value ="admin" placeholder="Password"></div>
